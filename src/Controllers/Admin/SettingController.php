...
class SettingController extends Controller
{
    ...
    public function show()
    {
        ...
        return view('vote::admin.settings', [
            ...
            'active_date' => setting('vote.active_date'),
    ...
    public function save(Request $request)
    {
        ...
        Setting::updateSettings([
            ...
            // Système date
            'vote.active_date' => $request->input('active_date'),
            'vote.whoStart' => $request->input('whoStart'),
            'vote.whoEnd' => $request->input('whoEnd'),
            'vote.maxDays' => $request->input('maxDays'),
        ]);
